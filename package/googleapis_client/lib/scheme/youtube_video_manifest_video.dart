...
class YoutubeVideoManifestVideo extends JsonScheme {
  ...
  static YoutubeVideoManifestVideo create({
    ...
    YoutubeVideoManifestVideo youtubeVideoManifestVideo = YoutubeVideoManifestVideo({
