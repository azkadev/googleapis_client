...
void main(List<String> args_raw) async {
  Future<Directory?> getPackageDirectory({
    String package_name = "package:googleapis_client_dart/googleapis_client_dart.dart",
  }) async {
  ...
  Directory? base_directory_lib = (await getPackageDirectory(package_name: "package:googleapis_client_dart/googleapis_client_dart.dart"));
  ...
  String name_exe = "googleapis_client_dart";
  String help_msg = """
A command-line googleapis_client_dart.
...
Global options:
  ...
  reload               Reload package googleapis_client_dart.dart
...
""";
  ...
  if (command == "version") {
    print("googleapis_client_dart version: 0.0.0 (stable) on ${Platform.operatingSystem}");
    exit(0);
  }
  ...
  if (command == "create") {
    try {
      ...
      List<String> templates = [
        "app_googleapis_client_template",
      ];
      ...
      if (templates.isEmpty) {
        templates = ["app_googleapis_client_template"];
      }
